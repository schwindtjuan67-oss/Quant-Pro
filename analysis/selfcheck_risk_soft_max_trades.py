...
def _run_case(run_mode: str, disable_flag: bool) -> tuple[RiskManager, str]:
...
def main() -> int:
    ...
    if out_disabled.count("[RISK] SOFT_MAX_TRADES disabled (PIPELINE)") != 1:
        failures.append("expected disabled log exactly once with flag")
